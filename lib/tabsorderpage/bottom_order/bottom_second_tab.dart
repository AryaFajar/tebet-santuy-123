...
class SecondBottomOrderPage extends StatefulWidget {
  final int totalHarga;
  final String menuName;
  final int menuPrice;
  final String menuDescription;

  final List<AnakItem> selectedAnak;
  ...
  @override
  State<SecondBottomOrderPage> createState() => _SecondBottomOrderPageState();
}

class _SecondBottomOrderPageState extends State<SecondBottomOrderPage> {
  ...
  void createOrderSecond() async {
    ...
    final orderData = {
      ...
      'anak_id': widget.selectedAnak.map((anak) => anak.namaAnak).join(),
